...
$n^{\backslash i}_{k}$ expresses the number of customers at table $k$. And $\alpha$ is a concentration parameter.
...
A first several durations of iterations called burn_in are error ranges. For that reason, burn_in durations are abandoned.
