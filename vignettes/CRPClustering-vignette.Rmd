...
$\cdot$ data : a matrix of data for clustering. Rows is data $i$ and cols is dimensions of data.  
$\cdot$ mu : numbers of center points of data. If data is 3 dim, a vector of 3 elements like "c(2,4,7)".  
$\cdot$ sigma : a number of data variance.  
$\cdot$ sigma_table : a number of table position variance.  
$\cdot$ alpha : a number of CRP concentrate rate.  
$\cdot$ ro_0 : a number of CRP mu change rate.  
$\cdot$ burn_in : iteration numbers of burn in.  
$\cdot$ iteration : iteration numbers.   
$\cdot$ z_result : a vector express cluster numbers for each data $i$. 
...
$\cdot$ data : a matrix of data for clustering. Rows is data $i$ and cols is dimensions of data.  
$\cdot$ z_result : a vector express cluster number for each data $i$. And the output of the method "crp_gibbs".      
