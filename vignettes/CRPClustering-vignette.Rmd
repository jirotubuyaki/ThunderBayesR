...
#### Clusters Entropy
Entropy  ambiguity of clustering. As a result of simulation, data $x_i$ joins in a particular table. From the total numbers $n_k$ of a particular table $k$ at the last iteration, a probability $p_k$ at each cluster $k$ is calculated. The entropy equation is given by  
